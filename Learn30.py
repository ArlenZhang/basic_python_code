...
# 使用在之前的抓取任务中
list_t = re.findall('<img src="([^"]*\.png)"', 'saddaf<img src="https://www.baidu.com/img/bd_logo1.png">ghgdhghg<br>'
                                               'saddaf<img src="https://www.baidu.com/img/bd_logo1.png">ghgdhghg<br>')
print(list_t)

# 执行下载
for eachUrl in list_t:
...
'''
print('==================ip==================')
pos = re.findall(r'((\d{1,2}|1\d{2}|2[0-5][0-5])\.){3}(\d{1,2}|1\d{2}|2[0-5][0-5])',
                 'sdfsdfsdfsdf11.231.1111.234erwed22.3.123.45dseeee3ra')
print(pos)
...
iter_t = re.finditer(r"(\w+) (\w+)", "I love china!")
